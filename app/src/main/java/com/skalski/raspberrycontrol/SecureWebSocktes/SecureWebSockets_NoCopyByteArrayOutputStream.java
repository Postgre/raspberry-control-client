 ...
 */
public class SecureWebSockets_NoCopyByteArrayOutputStream extends ByteArrayOutputStream {

   /**
    * Create new OutputStream backed by byte array.
    */
   public SecureWebSockets_NoCopyByteArrayOutputStream() {
      super();
   }
    ...
    */
   public SecureWebSockets_NoCopyByteArrayOutputStream(int size) {
      super(size);
   }
