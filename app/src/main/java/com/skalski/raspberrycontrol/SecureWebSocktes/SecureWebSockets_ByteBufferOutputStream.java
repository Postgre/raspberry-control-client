 ...
 */
public class SecureWebSockets_ByteBufferOutputStream extends OutputStream {
    ...
    */
   public SecureWebSockets_ByteBufferOutputStream() {
      this(2 * 65536, 65536);
   }
    ...
    */
   public SecureWebSockets_ByteBufferOutputStream(int initialSize, int growSize) {
