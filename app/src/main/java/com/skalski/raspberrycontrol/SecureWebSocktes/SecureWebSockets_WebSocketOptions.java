 ...
 */
public class SecureWebSockets_WebSocketOptions {
    ...
    */
   public SecureWebSockets_WebSocketOptions() {
    ...
    */
   public SecureWebSockets_WebSocketOptions(SecureWebSockets_WebSocketOptions other) {
