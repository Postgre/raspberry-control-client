 ...
 */
public class SecureWebSockets_WebSocketMessage {
	...
	public static class ProtocolViolation extends Message {
		...
		public SecureWebSockets_WebSocketException mException;

		public ProtocolViolation(SecureWebSockets_WebSocketException e) {
			mException = e;
		}
	}
